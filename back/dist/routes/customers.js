 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/:customerid', authenticateToken, requireAdmin, validateIdParam, async (req, res) => {
    try {
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/', authenticateToken, requireAdmin, validateCustomerCreation, handleValidationErrors, async (req, res) => {
    try {
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put('/:customerid', authenticateToken, requireAdmin, validateIdParam, validateCustomerUpdate, handleValidationErrors, async (req, res) => {
    try {
        const { customerid } = req.params;
        const { name, email, phone, address } = req.body;
